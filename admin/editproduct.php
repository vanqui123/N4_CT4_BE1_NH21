                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select id="inputStatus" class="form-control custom-select" name="manu">
                      <option value=<?php echo $value['manu_id']; ?>>Select One</option>
                      <?php foreach ($getAllManu as $muvalue) :  ?>
                        <option selected value=<?php echo $muvalue['manu_id']; ?>>
                  ...
                  <div class="form-group">
                    ...
                    <select id="inputStatus" class="form-control custom-select" name="type">
                      <option selected value=<?php echo $value['type_id']; ?>>Select One</option>
